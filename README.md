# apostille-me-test/upgrade-compatibility-tests
...
This repository is the `upgrade` deep-test suite for `apostille-me`. It is intentionally dependency-light and deterministic so failures can be reproduced locally without production credentials or customer data.
